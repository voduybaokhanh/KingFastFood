...
// mảng thể loại
var types = [
    new typeConstructor("Combo", "Combo thức ăn"),
    new typeConstructor("Burger", "Bánh Burger"),
    new typeConstructor("Chicken", "Gà Chiên Giòn"),
    new typeConstructor("Drink", "Nước giải khát"),
        ...
        if (productList[i].name == name) {
            document.querySelector('.Detail_Product_main_form').innerHTML = `
                ...
                <div class="Detail_Product_Sub_form">
                    ...
                    <div class="Detail_Product__Description"><strong>Chi tiết:</strong> ${productList[i].detail}</div>
